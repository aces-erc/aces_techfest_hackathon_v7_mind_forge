...
const Card = ({ children, title, description, buttonText, buttonColor }) => (
  <div className=" bg-white border-none rounded-xl border-t border-b border-gray-300 py-7 lg:py-9 px-6 lg:px-3 flex flex-col items-center text-center gap-4 lg:gap-5 shadow-lg register-card">
    <div
